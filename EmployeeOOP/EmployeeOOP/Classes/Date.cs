...
namespace EmployeeOOP.Classes
{
    public class Date
    {
        ...
        private int _year;              //El formato es: dia/mes/año
        private int _month;             //Pirvate, es porque solo lo usaremos para esta clase
        private int _day;               //Se puede usar la clase DateTime para obviar todo el desarrollo de a continuación
